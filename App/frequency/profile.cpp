...
VIP_ENCBOOL profile_func(sgx_status_t (*func)(sgx_enclave_id_t, VIP_ENCBOOL*, int*, size_t,int,int),
                    char* outFileName,
...
// VIP_ENCBOOL profile_func(sgx_status_t (*func)(sgx_enclave_id_t, VIP_ENCBOOL*, int*, size_t),
//                     char* outFileName,
//                     sgx_enclave_id_t eid,                    
//                     int* number, 
//                     size_t size){
...
// bool profile_func(bool (*func)(void),char* outFileName){
	...
	float total_time;     
    bool res = profile(eventVector,func,&total_time,eid,number,size,thenum,efreq);	
...
VIP_ENCBOOL profile(std::vector<PerfEvent>& events, sgx_status_t (*func)(sgx_enclave_id_t, VIP_ENCBOOL*, int*,size_t,int,int), 
            float* total_time,            
            sgx_enclave_id_t eid,            
            int* number, 
            size_t size,
...
// VIP_ENCBOOL profile(std::vector<PerfEvent>& events, sgx_status_t (*func)(sgx_enclave_id_t,VIP_ENCBOOL*, int*, size_t), 
//             float* total_time,
//             sgx_enclave_id_t eid,            
//             int* number, 
//             size_t size)
...
// bool profile(std::vector<PerfEvent>& events,bool (*func)(void),float* total_time){	
    ...
    bool res;
    sgx_status_t status = func(eid,&res,number,size,thenum,efreq);
