...
*/
    typedef struct enc_bool{
       ...
       /*** One-Input Operations ***/
        ...
        inline friend enc_bool operator& (enc_bool b1, int b2) __attribute__((always_inline)) {return enc_bool(b1.decrypt_bool() & b2); }
       ...
       /*** Two-Input Operations ***/
        // // Logic, Enc-Enc Op          
        inline friend enc_bool operator&& (enc_bool b1, enc_bool b2) __attribute__((always_inline)) {return enc_bool(b1.decrypt_bool() & b2.decrypt_bool()); }
        inline friend enc_bool operator&& (enc_bool b1, bool b2) __attribute__((always_inline)) {return enc_bool(b1.decrypt_bool() & b2); }
        inline friend enc_bool operator&& (bool b1, enc_bool b2) __attribute__((always_inline)) {return enc_bool(b1 & b2.decrypt_bool()); }
        inline friend enc_bool operator|| (enc_bool b1, enc_bool b2) __attribute__((always_inline)) {return enc_bool(b1.decrypt_bool() || b2.decrypt_bool()); }
        inline friend enc_bool operator|| (enc_bool b1, bool b2) __attribute__((always_inline)) {return enc_bool(b1.decrypt_bool() || b2); }
        inline friend enc_bool operator|| (bool b1, enc_bool b2) __attribute__((always_inline)) {return enc_bool(b1 || b2.decrypt_bool()); }
       ...
       /*** Other ***/
        ...
        inline friend enc_bool   CMOV(enc_bool cond, bool v_true, bool v_false) __attribute__((always_inline)) {
                uint16_t result;
                __asm__ __volatile__ (
                    "test   %1, %1;"
                    "cmovz  %3, %0;"  //zero flag cleared?
                    "cmovnz %2, %0;" //zero flag not cleared?
                    : "=r" (result)
                    : "r" (cond.decrypt_bool()), "r" ((uint16_t)v_true), "r" ((uint16_t)v_false)
                    : "cc"
                );
                return enc_bool(result);
        }
